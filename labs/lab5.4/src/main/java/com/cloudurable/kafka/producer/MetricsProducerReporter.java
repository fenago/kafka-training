...
//TODO MetricsProducerReporter should implement Runnable
public class MetricsProducerReporter  {
    ...
    //@Override
//    public void run() {
          //TODO In a forever loop, wait three seconds, then poll for metrics and call displayMetrics.
// HINT       while (true) {
// HINT           final Map<MetricName, ? extends Metric> metrics
//                    = producer.???();
//
