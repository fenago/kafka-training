...
## Use keytool to generate cluster certificate into a keystore
...
## Use openssl to Generate a Certificate Authority - CA
...
## Use keytool to sign a cluster certificate with the CA
...
## Use keytool to import CA and Signed Cluster Certificate into Kafka’s keystore
